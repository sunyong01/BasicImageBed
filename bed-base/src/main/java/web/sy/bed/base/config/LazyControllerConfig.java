...
public class LazyControllerConfig {
    ...
    private static class BeanFactoryPostProcessorWithPriority
        ...
        private boolean isExcludedBean(Class<?> beanClass) {
            ...
            return className.equals("web.sy.basicimagebed.controller.system.HealthController") ||
                    className.equals("web.sy.basicimagebed.config.SwaggerConfig") ||
                    className.equals("web.sy.basicimagebed.config.SecurityConfig") ||
                    className.equals("web.sy.basicimagebed.security.AuthenticationManager") ||
                    className.equals("web.sy.basicimagebed.security.UserDetailsService");
        }
